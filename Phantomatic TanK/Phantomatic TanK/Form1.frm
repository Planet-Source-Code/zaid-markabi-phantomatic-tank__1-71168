...
' «’ÿœ«„ «··«⁄»«‰ «·—∆Ì”Ì«‰ | CHECK IF THE BOTH PLAYERS IF COLLISION
...
End If
' «’ÿœ«„ «··«⁄»«‰ „⁄ «·„œ«›⁄ | CHECK IF THE BOTH PLAYERS IF COLLISION WHIT THE BOMBs
...
190:
' «·—”„ ⁄·Ï ·ÊÕ… «··«⁄» «·¬Ê· | RENDER TO THE FIRST PLAYER BOARD
...
' «·—”„ ⁄·Ï ·ÊÕ… «··«⁄» «·À«‰Ì | RENDER TO THE SECOND PLAYER BOARD
...
'  Õ—Ìﬂ «··«⁄» «·√Ê· | MOVE 1 PLAYER
        ...
        If InputEngine.IsKeyPressed(TV_KEY_NUMPAD4) = True Then ' «Œ Ì«— «·”·«Õ
...
187:
        ...
        If InputEngine.IsKeyPressed(TV_KEY_NUMPAD0) = True Then ' «ÿ·«ﬁ ‰«—
        If P1Gn > 0 Then
        If Gun1ON = False Then ' «–« ¬Œ— ÿ·ﬁ…  „ 
...
196:
        ...
        If InputEngine.IsKeyPressed(TV_KEY_NUMPAD2) = True Then ' ‰„ÿ «·ﬂ«„Ì—«
        ...
        If InputEngine.IsKeyPressed(TV_KEY_NUMPAD1) = True Then ' «” œ⁄«¡ œ»«»…
        If P1Money > 0 Then
        ...
        If InputEngine.IsKeyPressed(TV_KEY_NUMPAD3) = True Then ' «” œ⁄«¡ œ»«»…
        If P1Money > 49 Then
        If GetDistance3D(TankActor.GetPosition.X, 0, TankActor.GetPosition.z, MKR.X, 0, MKR.z) < 150 Then
        For I = 0 To 19
        If TankDBH1(I) < 1 Then
...
'  Õ—Ìﬂ «··«⁄» «·À«‰Ì | MOVE 2 PLAYER
        ...
        If InputEngine.IsKeyPressed(TV_KEY_X) = True Then ' «Œ Ì«— «·”·«Õ
...
195:
        ...
        If InputEngine.IsKeyPressed(TV_KEY_F) = True Then ' ‰„ÿ «·ﬂ«„Ì—«
        ...
        If InputEngine.IsKeyPressed(TV_KEY_E) = True Then ' «” œ⁄«¡ œ»«»…
        If P2Money > 0 Then
        ...
        If InputEngine.IsKeyPressed(TV_KEY_Z) = True Then ' «” œ⁄«¡ œ»«»…
        If P2Money > 49 Then
        If GetDistance3D(TankActor2.GetPosition.X, 0, TankActor2.GetPosition.z, MKR2.X, 0, MKR2.z) < 150 Then
        For I = 0 To 19
        If TankDBH2(I) < 1 Then
...
'  Õ—Ìﬂ «·‰«” ›Ì «·„œÌ‰…
For I5 = 0 To AllPpls - 1
If PplsDie(I5) = True Then ' «–« „Ì  ÌÃ «“Â
GoTo 45
End If
' Ì‰›⁄” »œ»«»… «··«⁄»«‰
